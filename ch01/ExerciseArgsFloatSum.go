// find the average value of floating-point numbers that are given as command-line arguments
package main
...
func main() {
	...
	convertArg := len(argsWithoutApp)
	fmt.Println("Number of arguments provided:", convertArg)
	fmt.Println("Total sum of provided", argsWithoutApp, "numbers is:", sum)
	fmt.Println("Average of all provided arguments is:", sum/convertArg)
}
